...
public class SimpleCheckableExpandableListAdapter<T> extends SimpleExpandableListAdapter
        implements CustomListAdapterInterface<T> {
    private static final String LOG_TAG =
            SimpleCheckableExpandableListAdapter.class.getSimpleName();
    private static final boolean DEBUG = BuildConfig.DEBUG && false;

    protected OnAdapterUpdateListener updateListener;
    ...
    public interface OnAdapterUpdateListener {
        ...
        @Nullable
        Boolean getCheckedStateFor(int groupPosition, int childPosition);
